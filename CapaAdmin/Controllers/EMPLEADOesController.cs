...
namespace CapaAdmin.Controllers
{
    public class EMPLEADOesController : Controller
    {
        ...
        {
            var eMPLEADOes = db.EMPLEADOes.Include(e => e.DEPARTAMENTO).Include(e => e.PUESTO).Include(e => e.TIPO_NOMINA);
        ...
        {
            ViewBag.ID_DEPARTAMENTO = new SelectList(db.DEPARTAMENTOes, "ID_DEPAR", "NOMBRE");
            ViewBag.ID_PUESTO = new SelectList(db.PUESTOes, "ID_PUES", "NOMBRE");
        ...
        public ActionResult Create([Bind(Include = "ID_EMPLE,CEDULA,NOMBRE,SALARIO,ID_DEPARTAMENTO,ID_PUESTO,ID_NOMINA")] EMPLEADO eMPLEADO)
        {
            ...
            ViewBag.ID_DEPARTAMENTO = new SelectList(db.DEPARTAMENTOes, "ID_DEPAR", "NOMBRE", eMPLEADO.ID_DEPARTAMENTO);
            ViewBag.ID_PUESTO = new SelectList(db.PUESTOes, "ID_PUES", "NOMBRE", eMPLEADO.ID_PUESTO);
